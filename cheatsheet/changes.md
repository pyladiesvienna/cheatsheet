...
Second: Start the server using `python manage.py runserver`.
...
```bash
$ pwd
/Users/you/projects/django_rocks
```
...
2. Check the directory of the files:
   ...
   changed are in the directory ``~/django_rocks``. Open your terminal again and type:
